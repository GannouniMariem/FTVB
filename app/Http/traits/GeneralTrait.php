...
trait GeneralTrait {
    ...
    public function retournSuccessMessage($msg ='',$errNum="S000"){
    ...
    public function retournDetaille($msg ='',$errNum="S000",$id_commande='',$prix_produit='',$prix_commande='',$taxe=''){
    ...
    public function retournPaiementObject($msg ='',$errNum="S000",$session_id='',$amount='',$mode_paiement='',$detailCommande=''){
