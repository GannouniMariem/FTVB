...
<div class="inner-page-banner">
    <div class="container">
        ...
        <h3 style="margin-top: 400px;padding-bottom: 1px;">L'equipe Nationale B Seniors <span class="color-yellow">'Dames'</span></h3>
      </div>
     </div>
    </div>
 </div>
         ...
         <section id="contant" class="contant">
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="feature-matchs">
               <h4>Championnat Nationale B seniors dames</h4>
