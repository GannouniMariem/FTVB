    ...
    <div class="container">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="slider-contant" data-animation="animated fadeInRight">
                      <h3 style="margin-top: 400px;padding-bottom: 1px;">Coupe de tunisie Seniors <span class="color-yellow">'Dames'</span></h3>
      </div>
     </div>
    </div>
 </div>
    ...
    <div class="row">
       <div class="container">
             ...
             <div class="feature-post">
                ...
                <div class="feature-cont">
                   ...
                   <div class="post-heading">
                      <h3>La liste des joueuse tunisiennes participants en Coupe d'Afrique 2021</h3>
                      <p>En battant l’Egypte sur le score de trois sets à zéro (25-22, 25-20, 25-15), la Tunisie a remporté 
                         son 9ème titre de champion d’Afrique. Un sacre mérité après une finale dominée de bout en bout par les coéquipiers Smaïl Moalla.
                      </p>
                      <h5> 27 Juin, 2021</h5>
          ...
          <div class="col-md-3">
             ...
             <h4 style="background-color: #D80E2A ; color: #fff;">PROCHAIN MATCHE</h4>
        ...
        <div class="col-md-12">
           <div class="full">
              <div class="main-heading sytle-2">
                 <h2>Galerie</h2>
     <p>Coupe de tunisie seniors dames</p>
              </div>
           </div>
        </div>
     </div>
...
<div class="main-heading sytle-2">
 <h2>Effectif</h2>
 <p> Les joueurs de coupe de tunisie seniors dames </p>
</div>
</div>
</div>
